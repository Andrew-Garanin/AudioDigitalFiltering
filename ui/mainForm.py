...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.buttonPlayOriginalSound = QPushButton(self.tab)
        self.buttonPlayOriginalSound.setObjectName(u"buttonPlayOriginalSound")
        self.buttonPlayOriginalSound.setGeometry(QRect(10, 130, 111, 51))
        ...
        self.buttonStop.setGeometry(QRect(130, 130, 101, 51))
        ...
        self.buttonPlayFilteredSound = QPushButton(self.tab)
        self.buttonPlayFilteredSound.setObjectName(u"buttonPlayFilteredSound")
        self.buttonPlayFilteredSound.setGeometry(QRect(10, 190, 111, 51))
        ...
        self.layoutWidget2.setGeometry(QRect(70, 170, 201, 24))
        ...
        self.buttonFilterDistortion.setGeometry(QRect(250, 210, 151, 41))
