...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.buttonPlayFilteredSound = QPushButton(self.tab_3)
        self.buttonPlayFilteredSound.setObjectName(u"buttonPlayFilteredSound")
        self.buttonPlayFilteredSound.setGeometry(QRect(130, 200, 111, 51))
        self.buttonPlayFilteredSound.setContextMenuPolicy(Qt.DefaultContextMenu)
        self.buttonStop = QPushButton(self.tab_3)
        self.buttonStop.setObjectName(u"buttonStop")
        self.buttonStop.setGeometry(QRect(250, 200, 101, 51))
        self.buttonPlayOriginalSound = QPushButton(self.tab_3)
        self.buttonPlayOriginalSound.setObjectName(u"buttonPlayOriginalSound")
        self.buttonPlayOriginalSound.setGeometry(QRect(10, 200, 111, 51))
